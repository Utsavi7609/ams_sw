        ...
        <div className="container px-5 py-24 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
          <div className="w-64 flex-shrink-0 md:mx-0 mx-auto text-center md:text-left md:mt-0 mt-10">
            <a className="flex title-font font-medium items-center md:justify-start justify-center text-white">
              ...
              <span className="ml-3 text-xl tracking-wide bg-gradient-to-r from-teal-400 to-blue-400 text-transparent bg-clip-text">The Indian Airline Management System</span>
            </a>
            <p className="mt-2 text-sm text-gray-500">
              Air plane banjo lyft occupy retro adaptogen indego
            </p>
          </div>
